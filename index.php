...
<head>
    ...
    <title>
        کارزار درخواست تشییع شهید سیدحسن نصرالله در ایران
    </title>
    <meta charset="UTF-8">
    ...
    <div class="container-fluid">
        <header class="headertop d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center">
                ...
                <div class="logo"> کارزار درخواست تشییع شهید سیدحسن نصرالله در ایران </div>
            </div>
        </header>
        ...
        <div class="row">
            ...
            <div class="w3-main w3-padding-large" style="margin-left:50%">
                ...
                <header class="w3-container w3-center" style="padding:30px 16px" id="home">
                    ...
                    <!-- <small>nasrollah.net</small> -->
                    <p style="text-align: justify;direction: rtl;color: #686464;">
                        شهید سید حسن نصرالله به عنوان یکی از افراد موثر در حوزه مقاومت، برای هر انسان آزاده‌ای و برای
                        ایرانی‌های عزیز مورد احترام است.
                        جهت قدردانی از زحمات چند دهه شهید والامقام در دفاع از مظلوم و دیدار آخر با ایشان و حمایت از محور
                        مقاومت و همبستگی با مردم داغدار لبنان و لبیک به ادامه حمایت از مظلوم به طور مشخص مردم
                        فلسطین و
                        غزه این پویش راه‌اندازی می‌شود.

                    </p> <i class="fa fa-hand-pointer-o"></i>
                ...
                <div class="w3-padding-32 w3-content" id="Comment" style="direction: rtl;">
                        ...
                        <div class="w3-row-padding w3-margin-bottom" tabindex="0">
                            <div class="w3-col l6 s12 m6">
                                <input tabindex="2" style="direction:rtl"
                                    class="w3-input w3-border w3-right-align w3-margin-bottom w3-round-small"
                                    type="text" name="name" placeholder="*نام و نام خانوادگی" required>
                            </div>
                            <div class="w3-col l6 s12 m6">
                                <input tabindex="1" style="direction:rtl"
                                    class="w3-input w3-border w3-right-align w3-margin-bottom w3-round-small"
                                    type="text" name="mob" placeholder="*شماره همراه" required>
                            </div>
                            <div class="w3-col l12 s12 m12">
                                ...
                                <select name="user_ostan" id="user_ostan"
                                    ...
                                    required tabindex="4" style="direction:rtl">
                                    <?php echo $ostan_row; ?>
                                </select>
                            </div>
                            ...
                            <div class="mb-3" style="margin-bottom: 15px;">
                                ...
                                <textarea maxlength="150" name="description" class="form-control  nasr_textarea"
                                    id="textarea" rows="5"></textarea>
                            </div>
                            ...
                            <div class="w3-col l12 s12 m12">
                                ...
                                <button tabindex="5" class="w3-button w3-green w3-round-large w3-block margin-bottom "
                                    type="submin"> ثبت و ارسال امضا <img style=" width: 26px; margin: 0;"
                                        src="<?=nasr_panel_image('arrow.svg')?>"></button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div id="otpModal" class="w3-modal">
                        <div class="w3-modal-content w3-animate-opacity w3-padding">
                            ...
                            <input id="otpInput" class="w3-input w3-border w3-margin-bottom" type="text"
